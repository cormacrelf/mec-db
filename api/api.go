...
func GetRoot(db *levigo.DB, params martini.Params) (int, string) {
	return 200, "stub"
}
...
func Delete(db *levigo.DB, params martini.Params, res http.ResponseWriter, req *http.Request) (int, string) {
	return 501, ""
}
